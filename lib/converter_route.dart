...
class _ConverterRouteState extends State<ConverterRoute> {
  ...
  Widget _createDropdown(BuildContext context, String currentValue,
    ...
    final input = Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _createDropdown(context, _fromValue.name, _updateFromConversion)
        ],
      ),
    );
    ...
    final output = Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _createDropdown(context, _toValue.name, _updateToConversion),
        ],
      ),
    );
